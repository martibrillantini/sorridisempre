...
def extract_mimic(args):
    ...
    if args.exit_point == 'All':
      vital_train.to_csv('/content/vital_train.csv')
      vital_dev.to_csv('/content/vital_dev.csv')
      vital_test.to_csv('/content/vital_test.csv')
      Y_train.to_csv('/content/inv_train.csv')
      Y_dev.to_csv('/content/inv_dev.csv')
      Y_test.to_csv('/content/inv_test.csv')
      static_train.to_csv('/content/static_train.csv')
      static_dev.to_csv('/content/static_dev.csv')
      static_test.to_csv('/content/static_test.csv')
    return
